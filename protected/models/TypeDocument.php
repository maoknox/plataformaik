 ...
 * @property string $label_document
 *
...
class TypeDocument extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name_document, label_document', 'required'),
			array('name_document, label_document', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_document, name_document, label_document', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'people' => array(self::HAS_MANY, 'Person', 'id_document'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('name_document',$this->name_document,true);
